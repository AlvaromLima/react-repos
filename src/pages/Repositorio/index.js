...
export default function Repositorio({match}){
    ...
    const [filterIndex, setFilterIndex] = useState(0); // começa em state: 'all'

    // busca e traz a requisição pelo repositorio que escolheu 
    useEffect(()=>{
        ...
        async function load(){
            ...
            // Faz 2 requisições ao mesmo tempo, com esse comando abaixo
            const [repositorioData, issuesData] = await Promise.all([
                api.get(`/repos/${nomeRepo}`),
                api.get(`/repos/${nomeRepo}/issues`, {
                    // busca as apis, com status open e 5 em 5
                    params:{
